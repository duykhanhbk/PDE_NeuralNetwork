...
for i in range(500):
    ...
    if (i + 1) % 50 == 0:
        ...
        model_path = './result/testnoBatchHD/model' + str(i + 1) + 'th_ite'
        # net.save(model_path)
        fig_path = './result/testnoBatchHD/' + str(i + 1) + 'th_ite.png'
...
plt.savefig('./result/testnoBatchHD/loss.png')

# with open('./result/testLightHD/batchloss.txt', 'w+') as f:
#     for loss in losses:
#         f.write(str(loss) + '\r\n')
...
plt.savefig('./result/testnoBatchHD/l2error.png')
# with open('./result/testLightHD/L2error.txt', 'w+') as f:
